...
if not os.path.exists("resources/NN_models/ImageNet_21k_BiT_M.gz"):
    wget.download(openimages_v4_inception_resnet_v2, "resources/NN_models/ImageNet_21k_BiT_M.gz")
